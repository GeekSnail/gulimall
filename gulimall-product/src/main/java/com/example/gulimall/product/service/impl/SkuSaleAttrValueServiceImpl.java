...
public class SkuSaleAttrValueServiceImpl extends ServiceImpl<SkuSaleAttrValueDao, SkuSaleAttrValueEntity> implements SkuSaleAttrValueService {
    ...
    @Override
    public List<SkuItemVo.SkuSaleAttrVo> getBySpuId(Long spuId) {
        return baseMapper.getBySpuId(spuId);
    }

    @Override
    public List<String> attrNameValueAsStringList(Long skuId) {
        return baseMapper.attrNameValueAsStringList(skuId);
    }
