...
INSERT INTO `QRTZ_CRON_TRIGGERS` VALUES ('RenrenScheduler','TASK_1','DEFAULT','0 0/30 * * * ?','Asia/Singapore');
...
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RenrenScheduler','LAPTOP-PCUDJT9K1687505487734',1688393692427,15000);
...
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RenrenScheduler','TASK_1','DEFAULT','TASK_1','DEFAULT',NULL,1688394600000,1688392800000,5,'WAITING','CRON',1679858747000,0,NULL,2,'��\0sr\0org.quartz.JobDataMap���迩��\0\0xr\0&org.quartz.utils.StringKeyDirtyFlagMap�����](\0Z\0allowsTransientDataxr\0org.quartz.utils.DirtyFlagMap�.�(v\n�\0Z\0dirtyL\0mapt\0Ljava/util/Map;xpsr\0java.util.HashMap���`�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\rJOB_PARAM_KEYsr\0.io.renren.modules.job.entity.ScheduleJobEntity\0\0\0\0\0\0\0\0L\0beanNamet\0Ljava/lang/String;L\0\ncreateTimet\0Ljava/util/Date;L\0cronExpressionq\0~\0	L\0jobIdt\0Ljava/lang/Long;L\0paramsq\0~\0	L\0remarkq\0~\0	L\0statust\0Ljava/lang/Integer;xpt\0testTasksr\0java.util.Datehj�KYt\0\0xpw\0\0�\Z�S8xt\00 0/30 * * * ?sr\0java.lang.Long;��̏#�\0J\0valuexr\0java.lang.Number������\0\0xp\0\0\0\0\0\0\0t\0renrent\0参数测试sr\0java.lang.Integer⠤���8\0I\0valuexq\0~\0\0\0\0\0x\0');
...
INSERT INTO `schedule_job` VALUES (1,'testTask','renren','0 0/30 * * * ?',0,'参数测试','2023-03-26 06:03:31');
...
CREATE TABLE `schedule_job_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `job_id` (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COMMENT='定时任务日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `schedule_job_log` VALUES (1,1,'testTask','renren',0,NULL,2,'2023-03-27 03:30:00'),(2,1,'testTask','renren',0,NULL,2,'2023-03-27 22:30:00'),(3,1,'testTask','renren',0,NULL,3,'2023-03-27 23:00:00'),(4,1,'testTask','renren',0,NULL,6,'2023-03-27 23:30:00'),(5,1,'testTask','renren',0,NULL,7410,'2023-03-28 00:00:00'),(6,1,'testTask','renren',0,NULL,58,'2023-03-28 00:30:01'),(7,1,'testTask','renren',0,NULL,3,'2023-03-28 01:00:00'),(8,1,'testTask','renren',0,NULL,4,'2023-03-28 01:30:00'),(9,1,'testTask','renren',0,NULL,3,'2023-03-28 02:00:00'),(10,1,'testTask','renren',0,NULL,20,'2023-03-28 02:30:00'),(11,1,'testTask','renren',0,NULL,1,'2023-04-07 18:30:00'),(12,1,'testTask','renren',0,NULL,2,'2023-04-07 23:30:00'),(13,1,'testTask','renren',0,NULL,4865,'2023-04-08 00:00:00'),(14,1,'testTask','renren',0,NULL,101,'2023-04-08 00:30:01'),(15,1,'testTask','renren',0,NULL,193,'2023-04-08 01:00:01'),(16,1,'testTask','renren',0,NULL,25,'2023-04-08 01:30:01'),(17,1,'testTask','renren',0,NULL,1,'2023-04-08 02:00:00'),(18,1,'testTask','renren',0,NULL,1,'2023-04-08 02:30:00'),(19,1,'testTask','renren',0,NULL,2,'2023-04-08 14:00:00'),(20,1,'testTask','renren',0,NULL,44,'2023-04-08 14:30:00'),(21,1,'testTask','renren',0,NULL,7,'2023-04-08 15:00:00'),(22,1,'testTask','renren',0,NULL,29,'2023-04-08 15:30:01'),(23,1,'testTask','renren',0,NULL,1,'2023-04-08 16:00:00'),(24,1,'testTask','renren',0,NULL,1,'2023-04-08 16:30:00'),(25,1,'testTask','renren',0,NULL,20,'2023-04-08 17:00:00'),(26,1,'testTask','renren',0,NULL,1,'2023-04-08 17:30:00'),(27,1,'testTask','renren',0,NULL,3,'2023-04-08 18:00:00'),(28,1,'testTask','renren',0,NULL,83,'2023-04-08 21:30:01'),(29,1,'testTask','renren',0,NULL,1,'2023-04-08 22:00:00'),(30,1,'testTask','renren',0,NULL,2,'2023-04-08 22:30:00'),(31,1,'testTask','renren',0,NULL,4,'2023-04-08 23:00:00'),(32,1,'testTask','renren',0,NULL,2,'2023-04-08 23:30:00'),(33,1,'testTask','renren',0,NULL,1804,'2023-04-09 00:00:00'),(34,1,'testTask','renren',0,NULL,24,'2023-04-09 00:30:00');
...
INSERT INTO `sys_captcha` VALUES ('085a6a7f-0b13-497a-875a-847b8e0353c2','26fgc','2023-04-16 15:51:55'),('1cc9623d-2c0b-4c02-8bdd-5ee11b93284c','gc7dd','2023-05-29 20:59:03'),('22331704-9357-4d4d-886d-8dbc5d24d533','gpdxm','2023-04-08 21:40:47'),('244400aa-5d6a-4e52-8f5e-ba38b8114aaa','b6b26','2023-04-08 02:42:16'),('2bd770ba-6d39-4458-8707-da6df79f6aa9','f587g','2023-04-27 00:08:39'),('2ef79b07-88c5-43c9-84f4-33d11fc23ed4','nn2yn','2023-04-08 02:47:48'),('31a92ef1-7388-4056-883a-89b81b176d66','nx6b6','2023-04-29 17:09:23'),('32602166-2c2e-42b0-8ee5-0a47682c6cbe','naynx','2023-04-07 18:10:31'),('3a895110-6691-4005-815a-d7c0c735ee4f','d4feb','2023-04-08 21:42:46'),('518caf0f-ff34-4789-887f-75f5262ab081','34cb3','2023-04-09 00:46:24'),('588851fb-c8d6-45df-8dea-10fcc3055a0e','x67eg','2023-04-16 16:14:21'),('690f3f97-ec7d-4df2-8690-8c589f89ce30','ffxen','2023-03-27 03:31:01'),('8ca791e9-2e48-4559-8b16-d48521fd2285','x4bfb','2023-04-08 02:42:54'),('9144d474-5b54-4666-82d5-728719eb9f10','27m3f','2023-05-04 22:16:37'),('9912ab78-8b83-40c0-89e2-917c8b84a911','7nxn7','2023-04-08 21:48:13'),('a94f103f-e12a-48e3-8ec9-3958ec7cca66','3aa6a','2023-04-16 15:49:52'),('aa499bec-f707-47d4-8507-dbcb422cfdc1','gpnw7','2023-04-07 18:10:57'),('ade7134b-0556-46bd-83e3-557628aeb8fe','d5yfe','2023-06-27 20:48:58'),('bb6a963e-de59-4d82-8b82-f4877baf59dd','357g6','2023-04-08 21:45:34'),('be17baec-bbb0-4255-835b-e9a82e82d034','x433c','2023-04-16 15:51:57'),('bf1e6369-cf84-4b37-8c55-234432c549fc','be366','2023-04-08 02:23:39'),('c64ad130-4800-4748-8c22-be5dd3a8d7c1','b5nw2','2023-05-27 21:35:15'),('e9ba4f7a-38bb-4c65-8901-6c47223cb4a8','bb258','2023-05-29 20:57:06');
...
INSERT INTO `sys_log` VALUES (1,'admin','保存菜单','io.renren.modules.sys.controller.SysMenuController.save()','[{\"menuId\":31,\"parentId\":0,\"name\":\"商品系统\",\"url\":\"\",\"perms\":\"\",\"type\":0,\"icon\":\"menu\",\"orderNum\":0,\"list\":[]}]',84,'0:0:0:0:0:0:0:1','2023-04-07 18:08:38'),(2,'admin','保存菜单','io.renren.modules.sys.controller.SysMenuController.save()','[{\"menuId\":32,\"parentId\":0,\"name\":\"分类管理\",\"url\":\"product/category\",\"perms\":\"\",\"type\":1,\"icon\":\"menu\",\"orderNum\":0,\"list\":[]}]',20,'0:0:0:0:0:0:0:1','2023-04-07 18:10:02'),(3,'admin','修改菜单','io.renren.modules.sys.controller.SysMenuController.update()','[{\"menuId\":32,\"parentId\":31,\"name\":\"分类管理\",\"url\":\"product/category\",\"perms\":\"\",\"type\":1,\"icon\":\"menu\",\"orderNum\":0,\"list\":[]}]',33,'0:0:0:0:0:0:0:1','2023-04-07 18:10:25'),(4,'admin','保存菜单','io.renren.modules.sys.controller.SysMenuController.save()','[{\"menuId\":33,\"parentId\":31,\"name\":\"品牌管理\",\"url\":\"product/brand\",\"perms\":\"\",\"type\":1,\"icon\":\"editor\",\"orderNum\":0,\"list\":[]}]',2879,'0:0:0:0:0:0:0:1','2023-04-16 01:54:00');
...
INSERT INTO `sys_user_token` VALUES (1,'f52874ccfd7d391a60fed6d9a78ae17d','2023-06-28 09:56:36','2023-06-27 21:56:36');
...
CREATE TABLE `oms_order` (
  ...
  `order_sn` char(36) DEFAULT NULL COMMENT 'order_sn',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4280 DEFAULT CHARSET=utf8mb4 COMMENT='订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_order` VALUES (1,1,'202306221500366961671775176013934594',NULL,'2023-06-22 15:00:38','bluebells',5999.0000,6007.0000,8.0000,0.0000,0.0000,0.0000,NULL,NULL,NULL,4,NULL,NULL,NULL,5999,5999,NULL,NULL,NULL,NULL,NULL,'bluebells','13312345678',NULL,'浙江省','杭州市','西湖区',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),(2,1,'202306221728167571671812337803223042',NULL,'2023-06-22 17:28:20','bluebells',5999.0000,6007.0000,8.0000,0.0000,0.0000,0.0000,NULL,NULL,NULL,4,NULL,NULL,NULL,5999,5999,NULL,NULL,NULL,NULL,NULL,'bluebells','13312345678',NULL,'浙江省','杭州市','西湖区',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),(3,1,'202306230149466361671938543903064065',NULL,'2023-06-23 01:49:51','bluebells',5999.0000,6007.0000,8.0000,0.0000,0.0000,0.0000,NULL,NULL,NULL,4,NULL,NULL,NULL,5999,5999,NULL,NULL,NULL,NULL,NULL,'bluebells','13312345678',NULL,'浙江省','杭州市','西湖区',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),(4,1,'202306230207412921671943051337052161',NULL,'2023-06-23 02:07:43','bluebells',5999.0000,6007.0000,8.0000,0.0000,0.0000,0.0000,NULL,NULL,NULL,1,NULL,NULL,NULL,5999,5999,NULL,NULL,NULL,NULL,NULL,'bluebells','13312345678',NULL,'浙江省','杭州市','西湖区',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),(5,1,'202306230241013231671951440062492674',NULL,'2023-06-23 02:41:07','bluebells',5999.0000,6007.0000,8.0000,0.0000,0.0000,0.0000,NULL,NULL,NULL,1,NULL,NULL,NULL,5999,5999,NULL,NULL,NULL,NULL,NULL,'bluebells','13312345678',NULL,'浙江省','杭州市','西湖区',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),(4279,1,'202306302332028831674802986114727938',NULL,'2023-06-30 23:32:09',NULL,NULL,4998.0000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `oms_order_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COMMENT='订单项信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_order_item` VALUES (1,NULL,'202306221500366961671775176013934594',3,'iPhone 14',NULL,NULL,225,1,'iPhone 14 红色','https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg',5999.0000,1,'颜色:红色',0.0000,0.0000,0.0000,5999.0000,5999,5999),(2,NULL,'202306221728167571671812337803223042',3,'iPhone 14',NULL,NULL,225,1,'iPhone 14 红色','https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg',5999.0000,1,'颜色:红色',0.0000,0.0000,0.0000,5999.0000,5999,5999),(3,NULL,'202306230149466361671938543903064065',3,'iPhone 14',NULL,NULL,225,1,'iPhone 14 红色','https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg',5999.0000,1,'颜色:红色',0.0000,0.0000,0.0000,5999.0000,5999,5999),(4,NULL,'202306230207412921671943051337052161',3,'iPhone 14',NULL,NULL,225,1,'iPhone 14 红色','https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg',5999.0000,1,'颜色:红色',0.0000,0.0000,0.0000,5999.0000,5999,5999),(5,NULL,'202306230241013231671951440062492674',3,'iPhone 14',NULL,NULL,225,1,'iPhone 14 红色','https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg',5999.0000,1,'颜色:红色',0.0000,0.0000,0.0000,5999.0000,5999,5999),(12,NULL,'202306302332028831674802986114727938',NULL,NULL,NULL,NULL,NULL,2,'iPhone 14 黑色',NULL,NULL,1,NULL,NULL,NULL,NULL,4998.0000,NULL,NULL);
...
CREATE TABLE `oms_payment_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `order_sn` char(36) DEFAULT NULL COMMENT '订单号（对外业务号）',
  `order_id` bigint(20) DEFAULT NULL COMMENT '订单id',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='支付信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_payment_info` VALUES (1,'202306230207412921671943051337052161',NULL,'2023062322001446490500228703',NULL,NULL,'TRADE_SUCCESS',NULL,NULL,NULL,'2023-06-23 00:00:00'),(2,'202306230241013231671951440062492674',NULL,'2023062322001446490500228704',NULL,NULL,'TRADE_SUCCESS',NULL,NULL,NULL,'2023-06-23 00:00:00');
...
CREATE TABLE `pms_attr` (
  ...
  PRIMARY KEY (`attr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='商品属性';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_attr` VALUES (1,'入网型号',1,'xx','aa;bb',1,1,225,1),(2,'上市年份',0,'xx','2022;2021;2020',1,1,225,0),(3,'颜色',0,'xxx','红色;蓝色;黑色',0,1,225,0),(4,'内存',0,'xx','4G;6G;8G',0,1,238,0),(5,'test',0,'xx','t',1,1,225,0);
...
CREATE TABLE `pms_attr_attrgroup_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='属性&属性分组关联';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1,2,2,NULL),(2,1,2,NULL),(6,5,1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='属性分组';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_attr_group` VALUES (1,'屏幕',0,'屏幕','xx',225),(2,'基本信息',0,'xx','xx',225);
...
INSERT INTO `pms_brand` VALUES (1,'Apple','https://202304.oss-cn-hongkong.aliyuncs.com/2023-04-26/7d177e82-0444-4c8a-8bba-e2cb337a494b_apple.png','苹果',1,NULL,NULL),(3,'test','http','t',1,'t',1),(4,'Pen','https://202304.oss-cn-hongkong.aliyuncs.com/2023-04-25/e6cb630d-4512-4b59-8704-c7570d574c9b2b1837c6c50add30.jpg','笔',1,'b',0),(9,'apple','https://202304.oss-cn-hongkong.aliyuncs.com/2023-04-26/7d177e82-0444-4c8a-8bba-e2cb337a494b_apple.png','苹果',1,'P',0);
...
CREATE TABLE `pms_category` (
  ...
  PRIMARY KEY (`cat_id`),
  KEY `category_parent_cid` (`parent_cid`)
...
INSERT INTO `pms_category_brand_relation` VALUES (1,1,225,NULL,NULL),(2,9,225,'apple','手机'),(3,9,235,'apple','苹果周边'),(4,4,521,'Pen','办公文具'),(5,3,521,'test','办公文具');
...
CREATE TABLE `pms_product_attr_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COMMENT='spu属性值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_product_attr_value` VALUES (12,1,5,'test','t',NULL,1),(13,1,2,'上市年份','2020',NULL,0),(14,1,1,'入网型号','aa',NULL,1),(18,2,5,'test','t',NULL,1),(19,2,2,'上市年份','2020',NULL,0),(20,2,1,'入网型号','aa',NULL,1),(21,3,5,'test','t',NULL,0),(22,3,2,'上市年份','2020',NULL,0),(23,3,1,'入网型号','aa',NULL,1);
...
CREATE TABLE `pms_sku_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='sku图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_sku_images` VALUES (1,1,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg',NULL,1),(2,2,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg',NULL,1),(3,2,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/8bd07c6f-b67a-4cf1-8802-f1327a896cf9_7ae0120ec27dc3a7.jpg',NULL,0),(4,1,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/8bd07c6f-b67a-4cf1-8802-f1327a896cf9_7ae0120ec27dc3a7.jpg',NULL,0);
...
CREATE TABLE `pms_sku_info` (
  ...
  PRIMARY KEY (`sku_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='sku信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_sku_info` VALUES (1,3,'iPhone 14 红色',NULL,225,1,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg','iPhone 14 红色','',5999.0000,0),(2,3,'iPhone 14 黑色',NULL,225,1,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/c8f3888a-001d-443a-8c50-c6243e7bbfd5_6a1b2703a9ed8737.jpg','iPhone 14 黑色','',5999.0000,0);
...
CREATE TABLE `pms_sku_sale_attr_value` (
  ...
  `attr_sort` int(11) DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='sku销售属性&值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_sku_sale_attr_value` VALUES (1,1,3,'颜色','红色',NULL),(2,2,3,'颜色','黑色',NULL);
...
CREATE TABLE `pms_spu_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='spu图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_spu_images` VALUES (1,1,NULL,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/8bd07c6f-b67a-4cf1-8802-f1327a896cf9_7ae0120ec27dc3a7.jpg',NULL,NULL),(2,2,NULL,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/8bd07c6f-b67a-4cf1-8802-f1327a896cf9_7ae0120ec27dc3a7.jpg',NULL,NULL),(3,3,NULL,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/8bd07c6f-b67a-4cf1-8802-f1327a896cf9_7ae0120ec27dc3a7.jpg',NULL,NULL);
...
CREATE TABLE `pms_spu_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='spu信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_spu_info` VALUES (1,'iPhone 14','iPhone 14',225,1,0.5000,0,'2023-05-10 11:59:28','2023-05-10 11:59:28'),(2,'iPhone 14','iPhone 14',225,1,0.5000,0,'2023-05-10 19:38:38','2023-05-10 19:38:38'),(3,'iPhone 14','iPhone 14',225,1,0.5000,1,'2023-05-10 19:56:44','2023-05-25 19:49:50');
...
INSERT INTO `pms_spu_info_desc` VALUES (1,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/faf885a8-02dd-4a61-87a0-fe699331b685_apple.png'),(2,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/faf885a8-02dd-4a61-87a0-fe699331b685_apple.png'),(3,'https://202304.oss-cn-hongkong.aliyuncs.com/2023-05-10/faf885a8-02dd-4a61-87a0-fe699331b685_apple.png');
...
INSERT INTO `sms_seckill_session` VALUES (1,'17:00','2023-06-30 23:00:00','2023-07-01 23:59:59',1,'2023-06-23 23:54:00');
...
CREATE TABLE `sms_seckill_sku_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='秒杀活动商品关联';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_seckill_sku_relation` VALUES (1,1,1,1,4999,10,1,1),(2,1,1,2,4998,12,1,1);
...
INSERT INTO `sms_sku_full_reduction` VALUES (1,NULL,5999.0000,50.0000,NULL),(2,NULL,5999.0000,50.0000,NULL),(3,NULL,5999.0000,50.0000,NULL);
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='商品阶梯价格';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_sku_ladder` VALUES (1,NULL,5000,0.98,NULL,NULL),(2,NULL,5000,0.98,NULL,NULL),(3,NULL,5000,0.98,NULL,NULL);
...
INSERT INTO `sms_spu_bounds` VALUES (1,1,5.0000,5.0000,NULL),(2,2,5.0000,5.0000,NULL),(3,3,5.0000,5.0000,NULL);
...
INSERT INTO `ums_member` VALUES (1,1,'bluebells','$2a$10$ATqRGzcEk2c8k5bE8..naOrqVZAsQbtv4m9XhbNTdHLXhuNXsh3Uy',NULL,'18812345678',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,1,'GeekSnail_8dd7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `ums_member_level` VALUES (1,'普通会员',0,1,99.0000,10,0,0,1,'初级会员'),(2,'青铜会员',1000,0,79.0000,10,0,1,1,'青铜会员'),(3,'白银会员',3000,0,59.0000,20,0,1,1,'白银会员');
...
INSERT INTO `ums_member_receive_address` VALUES (1,1,'bluebells','13312345678',NULL,'浙江省','杭州市','西湖区','xx路x号',NULL,1),(2,2,'geeksnail','13312345678',NULL,'浙江省','宁波市','鄞州区','xx路x号',NULL,1),(3,1,'bluebells','13312345678',NULL,'浙江省','杭州市','西湖区','xx路y号',NULL,0);
/*!40000 ALTER TABLE `ums_member_receive_address` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ums_member_social`
--

DROP TABLE IF EXISTS `ums_member_social`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ums_member_social` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ums_member_social`
--

LOCK TABLES `ums_member_social` WRITE;
/*!40000 ALTER TABLE `ums_member_social` DISABLE KEYS */;
INSERT INTO `ums_member_social` VALUES (1,2,'github',16624315,'GeekSnail','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',NULL,NULL);
/*!40000 ALTER TABLE `ums_member_social` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `wms_purchase` VALUES (1,1,'admin','13612345678',1,2,NULL,NULL,NULL,'2023-05-12 12:41:35'),(2,NULL,NULL,NULL,NULL,0,NULL,NULL,'2023-05-11 22:16:35','2023-05-11 22:16:35');
...
INSERT INTO `wms_purchase_detail` VALUES (1,1,1,12,NULL,1,3),(2,1,2,20,NULL,1,3);
...
INSERT INTO `wms_ware_info` VALUES (1,'1号仓库','北京','12345');
...
CREATE TABLE `wms_ware_order_task` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='库存工作单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wms_ware_order_task` VALUES (1,1,'202306221500366961671775176013934594',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,2,'202306221728167571671812337803223042',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,3,'202306230149466361671938543903064065',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,4,'202306230207412921671943051337052161',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,5,'202306230241013231671951440062492674',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `wms_ware_order_task_detail` VALUES (1,1,NULL,1,1,1,2),(2,1,NULL,1,2,1,2),(3,1,NULL,1,3,1,2),(4,1,NULL,1,4,1,2),(5,1,NULL,1,5,1,1);
...
INSERT INTO `wms_ware_sku` VALUES (1,1,1,12,'iPhone 14 红色',1),(2,2,1,20,'iPhone 14 黑色',0);
...
-- Dump completed on 2023-07-28  2:23:44
